        ...
        {phase === "menu" && (
          ...
          >
            <div className="max-w-sm w-full text-center text-white space-y-5">
              ...
              <Button
                size="lg"
                className="w-full bg-gradient-to-r from-purple-500 to-pink-600 hover:opacity-90 text-white font-bold"
                onClick={startGame}
              >
                Start
              </Button>
          ...
          >
            <div className="max-w-sm w-full text-center text-white space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button className="flex-1 bg-gradient-to-r from-purple-500 to-pink-600 text-white font-bold" onClick={startGame}>
                  Retry
                </Button>
              </div>
              <ArcadeLeaderboard gameId="rhythm_blade" currentUserId={userId} refreshKey={refreshKey} />
