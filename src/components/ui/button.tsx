  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl font-display font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground shadow-button hover:shadow-lg hover:brightness-110",
        game: "gradient-secondary text-secondary-foreground shadow-button hover:shadow-lg hover:brightness-110",
        accent: "gradient-accent text-accent-foreground shadow-button hover:shadow-lg hover:brightness-110",
      },
      size: {
