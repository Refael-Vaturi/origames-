      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute end-0 bottom-full mb-2 sm:bottom-auto sm:top-full sm:mb-0 sm:mt-2 z-[100] w-64 max-h-60 overflow-y-auto bg-card rounded-2xl shadow-card border border-border"
          >
            <div className="p-2">
