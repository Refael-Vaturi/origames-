      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 z-[100] w-64 max-h-60 overflow-y-auto bg-card rounded-2xl shadow-card border border-border" style={{ position: 'fixed' as any }}>
          >
            <div className="p-2">
